...
<html dir="ltr" lang="en-US"><head>
    <meta charset="utf-8">
    <title>Add Data For Donor</title>
...
<ul class="art-vmenu"><li><a href="registeration-be-donor.php" class="">Registeration Be Donor</a></li><li><a href="search-of-blood.php" class="">Search of Blood</a></li><li><a href="locations.php" class="">Locations</a></li><li><a href="feedback.php" class="">Feedback</a></li></ul>
                        ...
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader">Add Data For Donor</h2>
										<?php
										
                	mysql_connect("localhost","root","");
	                mysql_select_db("bb");
					if(isset($_POST['updata'])){
						$sqlupdata="UPDATE donor SET name='$_POST[name]',age='$_POST[age]',address='$_POST[address]',typeblood='$_POST[typeblood]' WHERE name='$_POST[hidden]'";
						mysql_query($sqlupdata);
						
					}
					if(isset($_POST['delete'])){
						$sqldelete="DELETE FROM donor  WHERE name='$_POST[hidden]'";
						mysql_query($sqldelete);
						
					}
					if(isset($_POST['add'])){
						$sqlinsert="INSERT INTO donor (name, age, address, typeblood) VALUES ('$_POST[aname]','$_POST[aage]','$_POST[aaddress]','$_POST[atypeblood]')";
                   ...
                   $result = mysql_query($sql);
					...
					echo"<td>" . "<input type=text name=typeblood value=" . $record['typeblood'] . " > " . "</td>";
					...
					echo"<td><input type=text name=aage  ></td>";
					echo"<td><input type=text name=aaddress  > </td>";
					echo"<td><input type=text name=atypeblood > </td>";
